...
public class AudioPlayerView {
	...
	@FXML
	protected Button button_repeat;
	@FXML
	protected Region button_play_region;
	@FXML
	...
	@FXML
	protected Label remaining;

	@FXML
	private Line middleLine;

	@FXML
	protected Label elapsed;
	@FXML
	...
	public void loadWaveform() {
		...
		if (width == 0 || height == 0)
			return;
		ByteArrayOutputStream outputStream = AudioUtils.getWaveform(width * WAVEFORM_SCALE_FACTOR,
				height * WAVEFORM_SCALE_FACTOR, audioPlayer.getCurrentAudioFile());

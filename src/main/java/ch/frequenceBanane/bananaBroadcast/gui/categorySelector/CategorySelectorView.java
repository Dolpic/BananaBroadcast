...
/**
 * Create a table filled with the different categories They are activable
 * on/off. This enables the user to have a selection of categories
 * 
 * @author Corentin
...
public class CategorySelectorView {
	...
	public void initialize() {
		...
		ArrayList<ArrayList<String>> categories = new ArrayList<>(Arrays.asList(selector.musicsCategories,
				selector.jinglesCategories, selector.cartouchesCategories, selector.tapisCategories));

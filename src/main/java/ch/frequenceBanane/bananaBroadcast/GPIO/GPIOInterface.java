...
/**
 * Handle connection between software and Axia GPIO driver. Enable user
 * functions to be called when a GPIO pin is triggered.
 * 
...
public class GPIOInterface extends Thread {
	 ...
	 * @throws IllegalArgumentException if the array is not of size 4, or the port
	 *                                  is negative
	 */
	...
	/**
	 * Bind a given runnable function to a specified pin on a specified GPIO When
	 * the given pin on the given GPIO is triggered, the function is called
	 * 
	 ...
	 * @throws IllegalArgumentException if GPIONumber or pinId is invalid, or func
	 *                                  is null
	 */

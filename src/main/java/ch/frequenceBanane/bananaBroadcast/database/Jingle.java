...
public class Jingle extends AudioFile {
	...
	public Jingle(final int id, final String title, final String[] panels, final String[] categories,
			final int duration, final int startTime, final int endTime, final String path) {
